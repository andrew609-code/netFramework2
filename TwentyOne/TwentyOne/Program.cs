...
namespace Casino2
{
    class Program
    {
        ...
        {
            const string casinoName = "Andrew's Casino !";
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y" || answer == "ya")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\marsh\logs\log.txt", true))
                {
                ...
                try
                {
                    ...
                    {
                        Console.WriteLine("An error occurred!, contact someone who cares !");

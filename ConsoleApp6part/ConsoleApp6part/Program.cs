...
namespace ConsoleApp6part
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Ask the user to input text to search for in list.
            ...
            //Creates a foreach loop that evaluates each item in the list, and displays a message showing the string and whether 
